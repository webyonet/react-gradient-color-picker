...
var barSize = constants_js_1.config.barSize, crossSize = constants_js_1.config.crossSize;
...
var getColorObj = function (colors) {
    ...
    return {
        currentColor: (ccObj === null || ccObj === void 0 ? void 0 : ccObj.value) || (constants_js_1.config === null || constants_js_1.config === void 0 ? void 0 : constants_js_1.config.defaultGradient),
