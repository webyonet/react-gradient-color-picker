...
export var useColorPicker = function (value, onChange) {
    ...
    var _b = getColorObj(colors), currentColor = _b.currentColor, selectedColor = _b.selectedColor, currentLeft = _b.currentLeft;
